...
package com.example.player.application;
...
public class Settings {
    ...
    public boolean getEnableBackgroundPlay() {
        ...
        Log.i("huge", "getEnableBackgroundPlay: "+mSharedPreferences.getBoolean(key, false));
    ...
    public void setEnableBackgroundPlay(boolean enableBackgroundPlay){
        String key = mAppContext.getString(R.string.pref_key_enable_background_play);
        mSharedPreferences.edit().putBoolean(key,enableBackgroundPlay).commit();
    }

    public int getPlayer() {
        String key = mAppContext.getString(R.string.pref_key_player);
        String value = mSharedPreferences.getString(key, "");
        Log.i("huge", "getPlayer: "+value);
        try {
    ...
    public boolean getUsingMediaCodec() {
        ...
        Log.i("TAG", "getUsingMediaCodec: "+mSharedPreferences.getBoolean(key, false));
        return mSharedPreferences.getBoolean(key, false);
    }
